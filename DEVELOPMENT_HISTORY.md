# Hara Vital — Development History (Pre-Pivot)
...
This document captures the historical development of Hara Vital through Week 4 (Jan 2026). It is **not** a current-state document — it explains the architecture choices that led to today's codebase, including the PQL system that was the original product.
