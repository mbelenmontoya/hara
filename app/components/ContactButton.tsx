...
export function ContactButton({
  ...
  return (
    <a
      ...
      className={`inline-flex items-center justify-center px-6 py-3.5 bg-brand text-white font-semibold rounded-full shadow-elevated hover:bg-brand-hover hover:shadow-strong active:scale-[0.98] transition-all duration-150 ${className} ${isTracking ? 'opacity-90' : ''}`}
    >
