...
export const metadata: Metadata = {
  title: 'Términos y privacidad | Hara Vital',
  description: 'Información legal básica de Hara Vital: términos de uso y política de privacidad en una sola página.',
}
...
const groups = [
  {
    id: 'terminos',
    title: 'Términos',
    intro: 'Estas condiciones explican el uso general de Hara Vital para quienes buscan recomendaciones y para profesionales que quieren formar parte de la plataforma.',
    disclosures: [
      {
        title: 'Qué ofrece Hara Vital',
        paragraphs: [
          'Hara Vital es una plataforma que facilita el vínculo entre personas y profesionales de bienestar. Podemos mostrar perfiles, recibir solicitudes, revisar postulaciones y sugerir contactos, pero no reemplazamos el criterio profesional ni brindamos atención clínica de emergencia.',
        ],
      },
      {
        title: 'Uso esperado de la plataforma',
        paragraphs: [
          'Al usar Hara Vital, aceptás utilizar la plataforma de buena fe, con información veraz y sin intentar interferir con su funcionamiento.',
        ],
        bullets: [
          ...
          'No uses Hara Vital para spam, hostigamiento o usos ilegales.',
        ],
      },
      {
        title: 'Recomendaciones y profesionales',
        paragraphs: [
          'Las recomendaciones, listados o coincidencias que aparezcan en Hara Vital son una ayuda para facilitar la búsqueda. La elección final y la relación entre una persona y un profesional siempre dependen de quienes participan en ese vínculo.',
      ...
      },
      {
        ...
        paragraphs: [
          'Podemos actualizar, pausar o cambiar partes de Hara Vital sin aviso previo si hace falta por mantenimiento, mejoras o seguridad. Hacemos lo posible por mantener la plataforma operativa, pero no garantizamos disponibilidad ininterrumpida.',
        ],
      },
      {
        title: 'Situaciones urgentes',
        paragraphs: [
          'Hara Vital no está pensado para emergencias. Si estás atravesando una situación urgente o de riesgo, buscá ayuda inmediata a través de los servicios de emergencia o de salud de tu zona.',
        ],
      },
    ],
  },
  {
    id: 'privacidad',
    title: 'Privacidad',
    intro: 'Acá resumimos cómo tratamos la información que compartís con Hara Vital cuando pedís recomendaciones, navegás la plataforma o te registrás como profesional.',
    disclosures: [
      {
      ...
      },
      {
        ...
        paragraphs: [
          'No vendemos tu información. La compartimos solo cuando hace falta para operar Hara Vital o cuando vos decidís avanzar con un contacto dentro del flujo del producto.',
        ],
        bullets: [
      ...
      },
      {
        ...
        paragraphs: [
          'Tomamos medidas razonables para cuidar la información, pero ningún sistema es infalible. Podemos actualizar esta política si cambia el producto, el flujo de trabajo o la forma en la que operamos Hara Vital.',
        ],
      },
    ],
  },
