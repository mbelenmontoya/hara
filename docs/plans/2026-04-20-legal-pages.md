...
**Goal:** Add the legal page planned in `.claude/plans/main.md` so Hara Vital has a public `/terminosyprivacidad` route that matches the current design system, keeps the page manageable on mobile, and is linked from active data-collection flows.
