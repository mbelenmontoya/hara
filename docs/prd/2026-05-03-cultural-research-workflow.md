...
- Brand spelling throughout this PRD: **Hara** (no accent — references the Japanese concept of the body's vital center). Existing DB seed has `'Hara Match'` as the literal account name; that's data, not prose, and is not in scope to change here.
